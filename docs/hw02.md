...
**Note:** For the homework, we will be looking for evidence that you completed these tasks in your [commit log](https://github.com/txt/se25/commits/main).
...
- Add the following standard files to your repo:  
  ...
  - `CONTRIBUTING.md`  
  - `CODE-OF-CONDUCT.md`  
  - (Reference: [Standard Files](https://softengbook.org/chapter2), [Choose a License](https://choosealicense.com/licenses/))  
...
- [ ] Task 2: Fix bug in module B  
- [ ] Task 3: Update documentation  
- [x] Task 4: Review pull requests  
- [x] Task 5: Merge latest changes  
...
#### Example Screenshots:  
<img src="https://github.com/user-attachments/assets/da3aa352-63e0-411b-8fe7-5980258d2672" width="400"/>

<img src="https://github.com/user-attachments/assets/2c53fddd-db60-4d25-95fa-208310610580" width="400"/>
...
- Create a **PDF file** containing:
  ...
  2. **One screenshot of your terminal** for **each group member** showing **your Git commands and terminal output** for Step **8 (Merge and Resolve Conflict).**
- Submit the **PDF file**.
