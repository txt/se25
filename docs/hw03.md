...
## **1. Getting Started**
1. **Download and unzip [`hw3.zip`](https://github.com/txt/se25/blob/updates/docs/hw3.zip).**
...
## 2. **Run Static Analysis Tools**
    ...
    **Each group members should be responcible for 1 tool**
## 3. Create your own branch. Add extra code (Any sorting algorithm with issues. Algorithm should be different from your group members).
